...
function HeroSection(props: { data: LandingDataTypes }) {
  ...
  return (
    <>
      {/* <!-- Hero --> */}
      <div
        className={`relative h-screen overflow-hidden before:absolute before:left-1/2 before:top-0 before:-z-[1] before:h-full before:w-full before:-translate-x-1/2 before:transform before:bg-top before:bg-no-repeat`}
      >
